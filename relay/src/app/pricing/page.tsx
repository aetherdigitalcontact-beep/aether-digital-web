            ...
            <div className="max-w-7xl w-full z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-start pb-32">
                ...
                >
                    ...
                    <button
                        ...
                        className="w-full py-3.5 rounded-full bg-white/5 border border-white/10 text-white font-black text-center text-[10px] uppercase tracking-widest hover:bg-white/10 transition-all mb-10 active:scale-[0.98]"
                    >
                        {d.pricing.cta}
                    </button>
                ...
                >
                    ...
                    <div className="bg-[#05070a] p-8 rounded-[40px] h-full flex flex-col">
                        ...
                        <button
                            ...
                            className="w-full py-4 rounded-full bg-accent text-white font-black text-center text-[10px] uppercase tracking-widest hover:shadow-[0_0_40px_rgba(59,130,246,0.4)] transition-all mb-10 active:scale-[0.98]"
                        >
                            {d.pricing.cta}
                        </button>
