...
function HomeContent({ initialUser, initialLang }: HomeClientProps) {
    ...
    if (isMaintenanceMode) {
        return (
            <div className="fixed inset-0 bg-[#020408] flex flex-col overflow-hidden">
                <CinematicBackground videoSrc="/videos/The Global Routing Hub.mp4" opacity={0.5} blendMode="screen" />
                <StarField />

                {/* ── Top bar ── */}
                <div className="relative z-30 flex items-center justify-between px-4 sm:px-8 md:px-12 py-3 sm:py-5 flex-shrink-0">
                    {/* Branding */}
                    <motion.div
                        whileHover={{ scale: 1.05, opacity: 1 }}
                        className="flex items-center gap-2 sm:gap-3 opacity-60 cursor-default group transition-opacity"
                    >
                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-blue-500/20 transition-all">
                            <Zap className="text-white w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" />
                        </div>
                        <span className="font-black text-lg sm:text-xl tracking-tighter text-white group-hover:text-blue-400 transition-colors">RELAY</span>
                    </motion.div>
                    ...
                    <motion.a
                        ...
                        whileTap={{ scale: 0.97 }}
                        className="flex items-center gap-2 px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl font-bold text-xs sm:text-sm text-white z-20 cursor-pointer select-none overflow-hidden"
                    ...
                    >
                        ...
                        <span className="relative hidden xs:inline">Contact Support</span>
                        <span className="relative xs:hidden">Support</span>
                    </motion.a>
                </div>
                ...
                <div className="relative z-10 flex-1 overflow-y-auto overflow-x-hidden flex items-center justify-center">
                    <div className="w-full max-w-4xl flex flex-col items-center text-center px-4 sm:px-6 py-6 sm:py-10">
                        ...
                        {/* ALPHA badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-[10px] sm:text-[11px] font-black uppercase tracking-[0.25em] text-white mb-4 sm:mb-6">
                            <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-blue-500 rounded-full animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.8)]" />
                            Relay Protocol Phase: ALPHA
                        </div>

                        {/* Logo */}
                        <div className="w-14 h-14 sm:w-20 sm:h-20 bg-accent rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-6 sm:mb-10 shadow-[0_0_60px_rgba(16,185,129,0.6)] relative group">
                            <Zap className="text-white w-7 h-7 sm:w-10 sm:h-10 z-10" fill="currentColor" />
                        ...
                        <p className="text-base sm:text-lg md:text-xl text-slate-400 font-medium leading-relaxed mb-8 sm:mb-12 max-w-sm sm:max-w-xl mx-auto">
                        ...
                        <div className="mt-6 sm:mt-10 flex items-center justify-center">
                            <Link
                                href="/roadmap"
                                className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-white/5 border border-white/10 hover:border-white/25 hover:bg-white/10 text-sm sm:text-base font-bold text-white/80 hover:text-white transition-all group"
                            >
                                <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400" />
                                View Engineering Roadmap
                                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 opacity-50 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-20 flex-shrink-0 flex flex-col items-center gap-1.5 py-3 sm:py-4 border-t border-white/[0.05]">
                    <div className="flex items-center gap-2 sm:gap-3">
                        <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-slate-700">Follow us</span>
                        <div className="h-px w-6 sm:w-8 bg-white/[0.07]" />
