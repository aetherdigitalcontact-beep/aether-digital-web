...
function HomeContent({ initialUser, initialLang }: HomeClientProps) {
    ...
    return (
        <main ref={containerRef} className="w-full bg-[#020408] relative overflow-hidden">
            ...
            {/* ── Footer social links ─────────────────── */}
            <footer className="relative z-10 w-full py-6 flex flex-col items-center gap-3 border-t border-white/[0.04]">
                <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-slate-600">Follow us</p>
                <div className="flex items-center gap-3">
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/aether-digital/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                        className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/[0.03] border border-white/[0.07] text-slate-500 hover:text-[#0A66C2] hover:border-[#0A66C2]/40 hover:bg-[#0A66C2]/10 transition-all">
                    ...
                    <a href="https://github.com/aetherdigitalcontact-beep" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
                        className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/[0.03] border border-white/[0.07] text-slate-500 hover:text-white hover:border-white/30 hover:bg-white/10 transition-all">
                        <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
