                ...
                {isMaintenanceMode && (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600">Follow us</span>
                                <div className="h-px w-12 bg-white/10" />
                                {/* LinkedIn */}
                                <a
                                    href="https://www.linkedin.com/in/exequiel-gutierrez-0993703b2/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="LinkedIn"
                                    className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/[0.04] border border-white/10 text-slate-400 hover:text-[#0A66C2] hover:border-[#0A66C2]/40 hover:bg-[#0A66C2]/10 transition-all"
                                >
                                ...
                                {/* GitHub */}
                                <a
                                    href="https://github.com/aetherdigitalcontact-beep"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="GitHub"
                                    className="flex items-center justify-center w-9 h-9 rounded-xl bg-white/[0.04] border border-white/10 text-slate-400 hover:text-white hover:border-white/30 hover:bg-white/10 transition-all"
                                >
                                    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                                ...
                                >
                                    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 5.84zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                    </svg>
                                </a>
                            </motion.div>
                        </motion.div>
